...
def calculate_makespan_spt(num_jobs, num_machines, job_times, job_sequences):
    ...
    for job in sorted_jobs:
        # Διαδοχική επεξεργασία κάθε μηχανήματος της εργασίας.
        for step in range(num_machines):
            ...
            # Ενημέρωση του προγράμματος του μηχανήματος,όπου λαμβάνεται υπόψη ο τρέχων χρόνος του μηχανήματος και η ολοκλήρωση της προηγούμενης εργασίας.
